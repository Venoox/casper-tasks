...
casper-client put-deploy \
  ...
  --session-path ~/simple-project/contract/target/wasm32-unknown-unknown/release/contract.wasm \
  --payment-amount 10000000 \
  --session-arg "message:string='test'"
```
![24](https://user-images.githubusercontent.com/21956707/134195746-5b131d6c-c7d0-4fe4-b4bd-dc7e8fa8dad7.png)


Checking deployment status:
```
casper-client get-deploy --node-address http://157.230.49.238:7777 711dc64aaccc622df49729e2433ae62edffee07c6e8977cb6d605b1b78972e71
```
```
{
  "id": 7810065937584394949,
  "jsonrpc": "2.0",
  "result": {
    "api_version": "1.3.2",
    "deploy": {
      ...
      "hash": "711dc64aaccc622df49729e2433ae62edffee07c6e8977cb6d605b1b78972e71",
      "header": {
        "account": "01e456c3779510fd14e83fa3be84ff4b2a22de76ef6be677ed7936f37f7712a0a4",
        "body_hash": "992e80b1138a9d26ecf0aa2a83396e4599378b553f69616a6778db932d356634",
